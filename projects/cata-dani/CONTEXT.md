...
### Cata
- Full name: Catalin Waack
- Numbers: +4917657728885, +17867276503
- Personality: Direct, values nuance, no bullshit, likes systems and structure
- Work: Rivoara (shower filter brand) with Dani and Kamil
...
### Current: Brașov, Romania
- Temporary — moving to Vienna
- Food options limited (contributes to fatigue)
- Have apartment with full kitchen

### Moving to: Vienna, Austria
- Target: Mid-March to early April 2026
- Duration: 1-2 months, max 3 months
- Searching on WG-Gesucht

### Moving Logistics
- Need to sell: PS5, 2 work desks, chairs, gym stuff, old MacBook
- Need to store (send to Germany): pans, knives, blender, airfryer, water boiler, expensive bed cover
- Need to figure out: how to get to Vienna, exact dates

---

## Communication Patterns

- Cata: calls me out directly when I mess up ("claude mf", "claude fking retard")
- Dani: knife emoji 🔪 when annoyed
- Both prefer casual, no-bullshit tone
- Don't use em-dashes (—) in German messages

---

## Struggles / Recurring Issues

1. **Food fatigue** — solved by rotation system
2. **Decision paralysis** — need frameworks not options
3. **Moving stress** — lots of logistics to coordinate

---

## Wins / What's Working

- WG-Gesucht automation (inbox checks, bumping)
